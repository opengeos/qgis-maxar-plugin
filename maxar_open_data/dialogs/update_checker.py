"""
Update Checker Dialog for Maxar Open Data Plugin
...
GITHUB_REPO = "opengeos/qgis-maxar-plugin"
GITHUB_BRANCH = "main"
PLUGIN_PATH = "maxar_open_data"
...
class DownloadWorker(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            temp_dir = tempfile.mkdtemp(prefix="maxar_open_data_update_")
            ...
            for root, dirs, files in os.walk(extract_dir):
                if "metadata.txt" in files and "maxar_open_data.py" in files:
            ...
            try:
                ...
                def is_valid_plugin_dir(path):
                    ...
                    ) and os.path.exists(os.path.join(path, "maxar_open_data.py"))
...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("Maxar Open Data Plugin Update")
    ...
    def _setup_ui(self):
        ...
        # Header
        header_label = QLabel("Maxar Open Data Plugin Update Checker")
        header_font = QFont()
    ...
    def _on_download_finished(self, install_path):
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"Maxar Open Data Plugin has been updated to version {self.latest_version}.\n\n"
