#!/usr/bin/env python3
"""
Package the Maxar Open Data QGIS plugin for upload to the official QGIS plugin repository.

This script creates a zip file with the following characteristics:
- Root folder renamed from 'maxar_open_data' to the target plugin name
...
def package_plugin(
    ...
    target_name: str = "maxar_open_data",
    ...
    Args:
        source_dir: Path to the maxar_open_data directory
        output_path: Optional path for the output zip file
        target_name: Name for the root folder in the zip (default: 'maxar_open_data')
...
def main():
    parser = argparse.ArgumentParser(
        description="Package Maxar Open Data QGIS plugin for repository upload",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output path for the zip file (default: maxar_open_data-{version}.zip in the same folder as this script)",
    )
    parser.add_argument(
        "--source",
        "-s",
        type=Path,
        default=None,
        help="Source directory (default: maxar_open_data in the same folder as this script)",
    )
    parser.add_argument(
        "--name",
        "-n",
        type=str,
        default="maxar_open_data",
        help="Target plugin name for the zip root folder (default: maxar_open_data)",
    )
    parser.add_argument(
        "--no-version",
        action="store_true",
    ...
    source_dir = args.source if args.source else script_dir / "maxar_open_data"
