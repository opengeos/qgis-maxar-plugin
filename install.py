#!/usr/bin/env python3
"""
Cross-platform installation script for Maxar Open Data QGIS Plugin.
...
def install_plugin(
    source_dir: Path, plugin_dir: Path, plugin_name: str = "maxar_open_data"
) -> bool:
...
def remove_plugin(plugin_dir: Path, plugin_name: str = "maxar_open_data") -> bool:
...
def main():
    parser = argparse.ArgumentParser(
        description="Install or remove Maxar Open Data QGIS Plugin"
    )
    parser.add_argument(
        "--remove",
        action="store_true",
    ...
    parser.add_argument(
        ...
        help="Plugin folder name in QGIS plugins directory (default: maxar_open_data)",
    )
    ...
    if args.remove:
        ...
        if success:
            ...
            print(f"  3. Enable 'Maxar Open Data'")
            print()
